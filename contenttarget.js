...
const applyButtons = () => {
  var divs = document.querySelectorAll('[class="Link__StyledLink-sc-4b9qcv-0 fUrQXY h-display-block"]');

  console.log("tagert i am here");
  console.log(divs);
  divs.forEach((div) => {
    var buttonElement =
      div.parentNode.querySelector(`.addedButton`) === null; //Check if button already exists
    if (buttonElement) {
      ...
      var url = `https://www.target.com${div.getAttribute("href")}`;
      ...
      div.parentNode.append(button);
      div.parentNode.append(newDiv);
      
      
      //newDiv.appendChild(ul);
      div.parentNode.append(body);
